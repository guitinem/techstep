...
const Cart = () => {
  ...
  const handleBuyAll = async () => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/cart/buy-all`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
      ...
      const data = await res.json()
      if (data.success) {
        toast.success('Purchase successful! All items have been ordered.')
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4'>
          <div className='bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all'>
            ...
            <div className='text-center mb-6'>
              ...
              <p className='text-gray-600'>Are you sure you want to buy all items?</p>
            </div>
            ...
            <div className='flex gap-4'>
              <button
                className='flex-1 py-3 px-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-400'
              ...
              <button
                className={`flex-1 py-3 px-6 font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
                  buyAllLoading
                    ? 'bg-gray-400 cursor-not-allowed'
                    : 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white'
                }`}
